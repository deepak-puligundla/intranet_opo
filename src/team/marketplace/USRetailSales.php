...
<head>
  ...
  <title>One Planet Ops - Intranet - Navigation header</title>

  <!-- Bootstrap Core CSS -->
  <link href="http://intranet.oneplanetops.com/intranet_opo/css/bootstrap-3.3.7-dist/css/bootstrap.css" rel="stylesheet" type="text/css">
  ...
  <div class="container">
    <div class="row">
      <div class="col-xs-6 col-md-3">
        <div class="thumbnail">
          <div class="caption">
	        <h4>Jennifer Brockhaus</h4>
   	      <h5>Senior Sales Executive - HI</h5>
      	 </div>
        </div>
      </div>
      ...
      <div class="col-xs-6 col-md-3">
        <div class="thumbnail">
          <div class="caption">
	        <h4>Belinda Leisure</h4>
   	      <h5>National Sales Executive - HG</h5>
      	 </div>
        </div>
      </div>
